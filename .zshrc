...
# apt
abbr -S agi='sudo apt install'
abbr -S agr='sudo apt remove'
abbr -S agu='sudo apt update'

# tools
abbr -S ag='sudo apt'
abbr -g -S c='xsel --clipboard --input'
abbr -S d='docker'
abbr -S g='git'
abbr -S h='history'
abbr -S t='tmux'
...
abbr -S gl='git pull'
abbr -S ga='git add'
abbr -S gac='git add -A && git commit'
